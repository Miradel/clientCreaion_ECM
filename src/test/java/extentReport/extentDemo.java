      ...
      //  htmlReporter.config().setAutoCreateRelativePathMedia(true);
       // htmlReporter.config().setProtocol(Protocol.HTTP);
        ...
        // Disable the diagram in the first Page
          ...
          htmlReporter.config().setLevel(Status.DEBUG);
        
          
          System.out.println( htmlReporter.config().getLevel().size() );
        //  System.out.println( htmlReporter.config().getLevel().get(0) );
...
//        extentLogger.info("End of the Report");
		...
		extentLogger2.pass(MarkupHelper.createLabel("step 1 is pass", ExtentColor.GREY));
...
//        extentLogger4.fail("Fail 2");
        ...
        extentLogger5.log(Status.FAIL, MarkupHelper.createLabel("Verification 2 is fail", ExtentColor.RED));
        extentLogger5.log(Status.FAIL, MarkupHelper.createTable(arr));
