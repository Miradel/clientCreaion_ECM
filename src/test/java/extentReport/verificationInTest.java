...
public class verificationInTest {
...
//	    extentLogger.info("End of the Report");
		...
		ExtentTest extentLogger11  = extentLogger.createNode("Verification").assignCategory("Verification");
		
		//extentLogger11.skip("aaaa");
		extentLogger11.pass("aaaa");
		extentLogger11.fail("aaaa");
		
		extentLogger11.log(Status.INFO, MarkupHelper.createLabel("Verifiy the Policy info successfully ", ExtentColor.GREEN));
		extentLogger11.log(Status.INFO, MarkupHelper.createLabel("Verifiy the Policy info fail ", ExtentColor.RED));
		
		extentLogger11.info("Verifivation Start");
	    extentLogger11.info("pass 1");
	   // extentLogger11.fail("Failed at step 2");
...
//	    extentLogger4.fail("Fail 2");
	    ...
	    extentLogger11.log(Status.INFO, MarkupHelper.createLabel("Verification 2 is fail", ExtentColor.RED));
	    extentLogger11.log(Status.INFO, MarkupHelper.createTable(arr));
